...
//             <button
//               type="submit"
//               className="bg-blue-600 text-white px-6 py-3 rounded-md h  over:bg-blue-700 transition w-full text-lg font-medium"
//             >
//               Send Message
//             </button>
//           </form>
...
import React from "react";
import { IconMapPin, IconPhoneCall, IconMail } from "@tabler/icons-react";

const Contact = ({ formikProps }) => {
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Enter your name"
              />
              <p className="text-red-500 text-sm">{errors.name && touched.name && errors.name}</p>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Type your message..."
              ></textarea>
              <p className="text-red-500 text-sm">{errors.message && touched.message && errors.message}</p>
            </div>

            <button
              type="submit"
              disabled={isSubmitting}
              className={`w-full text-lg font-medium px-6 py-3 rounded-md transition text-white ${
