...
const EditUserProfile = ({ formikProps }) => {
  const {
    values,
    handleChange,
    handleBlur,
  ...
  const handleFileChange = (event) => {
    ...
    if (file) {
      ...
      formikProps.setFieldValue("oldImage", "");
    }
  };

  useEffect(() => {
    console.log("Formik values.image:", formikProps.values.image);
        ...
        <div className="space-y-4">
          ...
          <div className="mt-1 flex items-center gap-4">
            ...
            {formikProps.values.image ? (
              ...
              />
            ) : formikProps.values.oldImage ? (
              <img
                src={formikProps.values.oldImage}
                alt="Existing"
                className="w-16 h-16 object-cover rounded-md border"
              />
            ) : null}
