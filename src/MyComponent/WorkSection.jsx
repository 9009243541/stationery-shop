    ...
    <section className="bg-white text-black py-12 px-4 md:px-20">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="text-sm md:text-base leading-relaxed mb-6">
          At{" "}
          <span className="font-semibold">Acharya VidhyaSagar Foundation</span>,
          we believe that education is every child's right. Each year, we
          organize a <strong>free notebook distribution drive</strong> for
          underprivileged children.
        </p>

        <p className="text-sm md:text-base leading-relaxed mb-6">
          In addition, we provide essential{" "}
          <strong>stationery items at highly discounted prices</strong>,
          ensuring affordability for everyone. All profits from these sales go
          directly toward feeding and supporting underprivileged students.
        </p>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <h3 className="font-semibold text-lg mb-2">
              🛍️ Discounted Stationery
            </h3>
            <p className="text-sm mb-4">
              Need notebooks anytime? Get them at <strong>minimum cost</strong>{" "}
              from our website. All earnings directly support children in need.
            </p>
